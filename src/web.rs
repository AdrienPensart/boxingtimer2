...
//             div { id: "left_panel", class: "space-y-1.5 flex flex-col",
//                 WebControls {}
//                 select {
//                     id: "sequences",
//                     name: "Sequence",
//                     class: "select select-success",
//                     size: global.timer.read().sequences().len(),
//                     oninput: move |ev| {
...
//                         ul {
//                             id: "sequence",
//                             title: sequence.description().as_deref(),
//                             class: "info p-2 rounded-xl bg-sky-900",
...
//                                     title: workout.description().as_deref(),
